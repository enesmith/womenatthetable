---
title: "COMPAS Race Analysis and Fairness Metrics"
...
```{python baseline set up, warning = FALSE, message = FALSE}
...
```{python pre-processing set up, warning = FALSE, message = FALSE}
lr = LogisticRegressionCV(solver='lbfgs')
...
```{python post-processing calibrated equal odds set up, warning = FALSE, message = FALSE}
from aif360.sklearn.postprocessing import CalibratedEqualizedOdds, PostProcessingMeta
