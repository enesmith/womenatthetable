...
\Author{Amrita Acharya$^{1, 2}$, Dianne Caravela$^{1, 3}$, Eunice Kim$^{1, 4}$, Emma Kornberg$^{1, 5}$, Elisabeth Nesmith$^{1, 6}$}
...
{\centering \includegraphics[width=500px,height=300px]{../images/table_snippet_new} 
...
{\centering \includegraphics[width=500px,height=300px]{../images/race_bar_plot} 

}

\caption{The race distribution for black people is 3000 and the distribution for white people is 2100. Therefore, there are more black people in the dataset than white people.}\label{fig:race plot}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=500px,height=300px]{../images/race_age_plot} 

}

\caption{This plot is a Kernel Density Estimate (KDE) plot. The y-axis represents the KDE of the Probability Distribution Function of the age variable in our dataset. The probability of a defendant's age being between two points on the x-axis is the total shaded area of the curve under the two points. The purple dotted line shows the average age of Black defendants and the green dotted line shows the average age of white defendants. For both groups, the majority of defendants are relatively young, but this is especially noticeable for Black defendants.}\label{fig:age plot}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=500px,height=300px]{../images/recid_bar_plot} 

}

\caption{Of both black and white people, there is a higher percentage of people who did not recidivate than who did. 2500 people recidivated, whereas approximately 2600 did not.}\label{fig:recid plot}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=500px,height=300px]{../images/race_recid_plot} 

}

\caption{When we divide the data into Black and white defendants, we can see that Black defendants recidivate more than white defendants. Black defendants recidivate are more likely than not to recidivate. However, we can also see that there are more Black defendants in the dataset in general.}\label{fig:recid race plot}
\end{figure}
