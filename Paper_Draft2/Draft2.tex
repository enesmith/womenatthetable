...
favors white defendants over Black defendants.}
...
\textbackslash{}caption\{When we divide the data into Black and white
defendants, we can see that Black defendants recidivate more than white
defendants and Black defendants are more likely to recidivate than not
recidivate. 39.14\% of white defendants did recidivate within two years
compared to 52.35\% of black defendants. We can also see that there are
more Black defendants in the dataset
overall.\}\label{fig:recidivism mosaic} \textbackslash{}end\{figure\}
...
data into one or more sets'' \citep{baxter2021what}. The in-processing
