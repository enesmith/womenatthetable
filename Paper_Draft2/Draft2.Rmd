...
```{r race plot, echo=FALSE, fig.align='center', fig.cap= 'This plot shows the distribution of defendant races.', out.width= "500px", out.height= "300px"}
knitr::include_graphics("../images/race_bar_plot.png")
```

```{r age plot, echo=FALSE, fig.align='center', fig.cap= 'This plot shows the distribution of defendant ages by race.', out.width= "500px", out.height= "300px"}
knitr::include_graphics("../images/race_age_plot.png")
```

```{r recid plot, echo=FALSE, fig.align='center', fig.cap= 'This plot shows the distribution of two year recidivism outcomes.', out.width= "500px", out.height= "300px"}
knitr::include_graphics("../images/recid_bar_plot.png")
```

```{r recid race plot,echo=FALSE, fig.align='center', fig.cap= 'This plot shows the distribution of two year recidivism outcomes by race.', out.width= "500px", out.height= "300px"}
