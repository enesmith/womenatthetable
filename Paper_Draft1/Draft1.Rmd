...
```{r table snip, fig.align='center', fig.cap= 'This table is a snippet the data set we will be using.'}
knitr::include_graphics("/Users/elisabethnesmith/womenatthetable/images/table_snippet.png")
```

```{r race plot, fig.align='center', fig.cap= 'This plot shows the distribution of defendant races.'}
knitr::include_graphics("/Users/elisabethnesmith/womenatthetable/images/race_bar_plot.png")
```

```{r age plot, fig.align='center', fig.cap= 'This plot shows the distribution of defendant ages by race.'}
knitr::include_graphics("/Users/elisabethnesmith/womenatthetable/images/race_age_plot.png")
```

```{r recid plot, fig.align='center', fig.cap= 'This plot shows the distribution of two year recidivism outcomes.'}
knitr::include_graphics("/Users/elisabethnesmith/womenatthetable/images/recid_bar_plot.png")
```

```{r recid race plot, fig.align='center', fig.cap= 'This plot shows the distribution of two year recidivism outcomes by race.'}
