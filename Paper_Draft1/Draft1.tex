...
\Author{Amrita
Acharya$^{1,2,\ddagger,*}$\href{https://orcid.org/0000-0003-3293-2315}{\orcidicon}, Dianne
Caravela$^{2, \dagger, \ddagger}$, Eunice Kim$^{3}$, Emma
Kornberg$^{4}$, Elisabeth Nesmith$^{5}$}
...
\address{%
$^{1}$ \quad Smith
College; \href{mailto:aarcharya@smith.edu}{\nolinkurl{aarcharya@smith.edu}}\\
$^{2}$ \quad Smith
