...
```{python make degree numeric}
#av_defendant = (df_viz.groupby(['race'],as_index=False).age.mean()
#display(df_viz)
#list_vars = list(df_viz)
#list_vars
#df_numeric_charges = df_viz['c_charge_degree'].replace(['M', 'F'], [0, 1], inplace=True)
#plt.bar('c_charge_degree', 1, data = df_viz)
```
...
#y_proba_EO = eo.predict_(test_BLD)
=======
>>>>>>> cbe711918fbe5ff21a86d924ac5e5d8b15897c9d
