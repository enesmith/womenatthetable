...
```{python crosstable of recitivism by race}
...
Compared to the baseline model, the predjudice remover is highly in favor of the unprivileged group because its value is greater than 0. The value of .367 is much higher than 0, the value of fairness. 
...
Compared to the baseline model, the predjudice remover is highly in favor of the unprivileged group because its value is greater than 0. The value of .321 is much higher than 0, the value of fairness. 
...
Compared to the baseline model, the predjudice remover is highly in favor of the unprivileged group because its value is greater than 0. 
...
At the value of 0.134, the statistical parity difference is now positive and slightly in favor of black defendants. 
...
There has been a significant change from -.408 to 0.088, showing that now the value is within the bounds of "fair" (-0.1 to 0.1)
...
The baseline model with the average odds difference was -0.438 and now it is 0.15 which indicates being slightly in favor of black defendants. 
...
The baseline value was 0.466 which is highly out of the range of "fair" which goes up to 1. Now at a value of 1.2 it is much higher than 1. 
