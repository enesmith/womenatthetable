...
Of both Black and white people, there is a higher percentage of people who did not recidivate than who did. 2500 people recidivated, whereas approximately 2600 did not.
...
The race distribution for black people is 3000 and the distribution for white people is 2100. Therefore, there are more black people in the dataset than white people.
...
When we divide the data into Black and white defendants, we can see that Black defendants recidivate more than white defendants and Black defendants recidivate more than not recidivate. However, we can also see that there are more Black defendants in the data set in general.

Black defendants are more likely to recidivate than not recidivate. This increased likelihood of recidivating may be attributed to the systemic racism in policing (e.g., predominantly Black neighborhoods tend to be overpoliced in comparison to predominantly white neighborhoods").
...
The highest percentage is for true negatives, those guessed to not recidivate and actually did not, at 35.41%. Similarly, the true positive rate is 25.85%. Our false negative and positive rates, incorrect guesses, is high for this baseline model, indicating that debiasing intervention may be necessary to lower these rates.
